...
| 參數類別 | 數據項 (Field) | 內容 / 說明 |
| :--- | :--- | :--- |
| **基本資訊** | **NORAD 衛星編號** | `44713` <br> 用來確認兩行是同一顆衛星 |
| | **Classification** | `U` <br> 軍事/民用分類用 (U 為非機密) |
| | **國際編號** | `19074A` <br> 發射年份 + 第幾次發射 + 分離物件代碼 |
| **時間與阻力** | **TLE 參考時間點** | `23314.42416486` <br> 2023年第314天的小數時間 (Epoch) |
| | **空氣阻力參數** | `84661-3` <br> 描述大氣阻力效應 (BSTAR) |
| **軌道幾何** | **軌道傾角 (Inclination)** | `53.0550` <br> 軌道平面與地球赤道的夾角 |
| | **升交點赤經 (RAAN)** | `43.6089` <br> 軌道平面在地球周圍的方向角 |
| | **軌道偏心率 (Eccentricity)** | `0001326` <br> 軌道的橢圓程度 (隱含小數點) |
| **運動狀態** | **平均運動 (Mean Motion)** | `15.06437851` <br> 每天繞行地球的圈數 |
