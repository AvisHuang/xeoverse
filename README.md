...
| 數據項 (Field) | 內容 / 說明 |
| :--- | :--- |
| **NORAD 衛星編號** | `44713` <br> 用來確認兩行是同一顆衛星 |
| **Classification** | `U` <br> 軍事/民用分類用 (U 為非機密) |
| **國際編號** | `19074A` <br> 發射年份 + 第幾次發射 + 分離物件代碼 |
| **TLE 參考時間點** | `23314.42416486` <br> 2023年第314天的小數時間 (Epoch) |
| **空氣阻力參數** | `84661-3` <br> 描述大氣阻力效應 (BSTAR) |


| 參數名稱 | 原始數值 | 定義與功能說明 |
| :--- | :--- | :--- |
| **NORAD 衛星編號** | `44713` | 用來確認兩行是同一顆衛星。 |
| **軌道傾角 (Inclination)** | `53.0550` | 軌道平面與地球赤道的夾角，決定衛星能飛到的緯度範圍。 |
| **升交點赤經 (RAAN)** | `43.6089` | 軌道平面在地球周圍的方向角，影響衛星在地球上方的位置。 |
| **軌道偏心率 (Eccentricity)** | `0001326` | 軌道的橢圓程度（此處為 0.0001326，接近圓形軌道）。 |
| **平均運動 (Mean Motion)** | `15.06437851` | 每天繞行地球的圈數。 |
