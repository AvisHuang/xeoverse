...
| 19074A | 發射年份 + 第幾次發射 + 分離物件代碼 | 43.6089 | 軌道平面在地球周圍的方向角 |
| 23314.42416486 | TLE 的參考時間點 | 0001326 | 偏心率 |
| 84661-3 | 空氣阻力參數 | 15.06437851 | 平均運動 |
| | 用來確認兩行是同一顆衛星 | | 用來確認兩行是同一顆衛星 |
| | 軍事/民用分類用 | | 決定衛星能飛到哪些緯度 |
| | | | 影響衛星在地球上方的位置 |
| | 2023年第314天 的小數時間 | | 軌道的橢圓程度 |
| | 描述大氣阻力效應 | | 每天繞地球幾圈 |
